...
## 14) Week2 성능 실측 3차 결과 (병목 구간 집중)
- 실행 방식
	- Step Load: 500 -> 700 -> 900 RPS, 각 90초
	- 동시성: 80 / 100 / 120
- 결과 파일
	- 3차: `performance-week2-result-round3.json`
- 요약
	- S1(500 RPS): avg 2.11ms / p95 1.34ms / Error 0.00%
	- S2(700 RPS): avg 2.31ms / p95 1.41ms / Error 0.00%
	- S3(900 RPS): avg 2.37ms / p95 1.35ms / Error 0.00%
- 결론
	- 900 RPS까지는 유의미한 병목 징후 없이 안정 구간 유지
	- 다음 실험은 1200+ RPS 또는 Kafka 파티션/ACK 조건 변경으로 병목 구간을 더 명확히 확인

## 15) Week2 성능 실측 4차 결과 (1200+ RPS 확장)
- 실행 방식
	- Step Load: 1200 -> 1500 -> 1800 RPS, 각 90초
	- 동시성: 150 / 180 / 220
- 결과 파일
	- 4차: `performance-week2-result-round4.json`
- 요약
	- S4(1200 RPS): avg 2.32ms / p95 1.34ms / Error 0.00%
	- S5(1500 RPS): avg 2.92ms / p95 1.46ms / Error 0.00%
	- S6(1800 RPS): avg 6.85ms / p95 3.47ms / Error 0.00%
- 결론
